      ...
      <div className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="rounded-lg bg-sourceful-gray-100 dark:bg-sourceful-gray-800 border border-sourceful-gray-200 dark:border-transparent p-4 font-mono text-sm text-sourceful-gray-900 dark:text-white overflow-x-auto">
              <pre><code>{`import "@ramp-ds/ui/styles.css"`}</code></pre>
            </div>
          </div>
...
import "@ramp-ds/ui/styles.css"  // FIRST
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground mt-2">
              <li>Verify <code className="bg-muted px-1.5 py-0.5 rounded text-sm">@ramp-ds/ui/styles.css</code> is imported FIRST</li>
              <li>Check package version is 0.1.22+: <code className="bg-muted px-1.5 py-0.5 rounded text-sm">npm list @ramp-ds/ui</code></li>
            </ul>
          </div>
          <div>
