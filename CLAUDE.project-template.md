...
import "@ramp-ds/ui/styles.css"  // FIRST - contains CSS variables
import "./globals.css"                     // SECOND - project overrides

// 2. Import components as needed
import { Button, Card, Badge, Input, Label } from "@ramp-ds/ui"
...
- Don't import `@ramp-ds/ui/styles.css` AFTER your globals.css

### Troubleshooting

**Unstyled components / CSS variables undefined:**
- Verify `@ramp-ds/ui/styles.css` is imported FIRST in your layout
- Check package version is 0.1.22 or later: `npm list @ramp-ds/ui`
